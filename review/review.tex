...
\item My general impression is that the contribution of this paper is more theoretical than methodological, which deviates from the main interest of the journal. Most of the introduced methods have been proposed and well studied in the literature. For example, the "median-of-means" approach, one of the major focuses of this paper, has been studied in univariate and multi-dimensional settings in \citet{HSa16} and \citet{Min15} respectively. ...

\item The paper presents abc. 

\item Assumption 1 requires each subsample-based estimator to ...
...
\begin{thebibliography}{99}
	\bibitem[{Hsu and Sabato(2016)}]{HSa16}Hsu, D. and Sabato S. (2016) Loss minimization and parameter estimation with heavy tails.  \emph{J. Mach. Learn. Res.}, \textbf{17}, 1--40.
	\bibitem[Minsker(2015)]{Min15}Minsker, S. A. (2015) Geometric median and robust estimation in Banach spaces. \emph{Bernoulli}, \textbf{21}, 2308--2335. 
\end{thebibliography} 
